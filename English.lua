en = {
    ...
    fruit = {
        ...
        sec_advance       = 'Advance Fruit Stock',
        sec_normal        = 'Normal Fruit Stock',
        error_title       = 'Error',
        error_advance     = 'Failed to load Advance Stock',
        error_normal      = 'Failed to load Normal Stock',
        not_found_title   = 'Not Found',
        not_found_advance = 'No advance fruits currently in stock.',
        not_found_normal  = 'No normal fruits currently in stock.',
    },
